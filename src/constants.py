...
ORDER_DOC_2 = """<?xml version="1.0" encoding="UTF-8"?>
<Order xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns="urn:oasis:names:specification:ubl:schema:xsd:Order-2">
	<cbc:UBLVersionID>2.0</cbc:UBLVersionID>
	<cbc:CustomizationID>urn:oasis:names:specification:ubl:xpath:Order-2.0:sbs-1.0-draft</cbc:CustomizationID>
	<cbc:ProfileID>bpid:urn:oasis:names:draft:bpss:ubl-2-sbs-order-with-simple-response-draft</cbc:ProfileID>
	...
	<cac:OrderLine>
		...
		<cac:LineItem>
			...
			<cac:Item>
				<cbc:Description>Gardening fertiliser</cbc:Description>
				<cbc:Name>fertiliser</cbc:Name>
				<cac:BuyersItemIdentification>
					<cbc:ID>6578490</cbc:ID>
				</cac:BuyersItemIdentification>
				<cac:SellersItemIdentification>
...
ORDER_DOC_3 = """<?xml version="1.0" encoding="UTF-8"?>
<Order xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns="urn:oasis:names:specification:ubl:schema:xsd:Order-2">
	<cbc:UBLVersionID>2.0</cbc:UBLVersionID>
	<cbc:CustomizationID>urn:oasis:names:specification:ubl:xpath:Order-2.0:sbs-1.0-draft</cbc:CustomizationID>
	<cbc:ProfileID>bpid:urn:oasis:names:draft:bpss:ubl-2-sbs-order-with-simple-response-draft</cbc:ProfileID>
	<cbc:ID>AEG012347</cbc:ID>
	<cbc:SalesOrderID>CON0095680</cbc:SalesOrderID>
	<cbc:CopyIndicator>false</cbc:CopyIndicator>
	...
	<cac:OrderLine>
		...
		<cac:LineItem>
			...
			<cac:Item>
				<cbc:Description>Banana bread</cbc:Description>
				<cbc:Name>banana bread</cbc:Name>
				<cac:BuyersItemIdentification>
					<cbc:ID>6578491</cbc:ID>
				</cac:BuyersItemIdentification>
				<cac:SellersItemIdentification>
					<cbc:ID>17589685</cbc:ID>
				</cac:SellersItemIdentification>
			</cac:Item>
		</cac:LineItem>
	</cac:OrderLine>
